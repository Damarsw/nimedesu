...
async function initStream() {
    ...
    try {
        ...
        if (data && data.episodes && data.episodes.length > 0) {
            ...
            // SORTING STRING SECARA ALFABETIS ("01", "02", "03"...)
...
function renderDynamicEpisodes() {
    ...
    // RENDER TOMBOL DENGAN TEKS JELAS DAN AMAN DARI TRANSPARANSI
    container.innerHTML = activeEpisodes.map((ep, index) => {
        ...
        let epLabel = `Eps ${epVal}`; // Teks tombol jadi jelas ("Eps 01", "Eps 02", dst)
